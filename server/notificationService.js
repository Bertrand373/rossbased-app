...
const notificationTemplates = {
  ...
  // Day 1: Welcome (no premium mention)
  onboarding_day1: {
    title: 'You\'re In',
  ...
  // Day 3: Build the habit (no premium mention)
  onboarding_day3: {
    title: 'Day 3',
  ...
  // Day 7: First week milestone (no premium mention)
  onboarding_day7: {
    title: 'One Week',
  ...
  // Day 14: Two weeks — soft premium mention
  onboarding_day14: {
    title: 'Two Weeks In',
